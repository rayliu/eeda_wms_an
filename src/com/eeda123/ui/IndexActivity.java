...
import com.eeda123.adapter.IndexGalleryAdapter;
import com.eeda123.entity.IndexGalleryItemData;
import com.eeda123.ui.base.BaseActivity;
import com.eeda123.ui.gateOut.SearchBarcodeActivity;
import com.eeda123.ui.transferOrder.SearchTransferOrderActivity;
import com.eeda123.utils.CommonTools;
import com.eeda123.widgets.HomeSearchBarPopupWindow;
import com.eeda123.widgets.HomeSearchBarPopupWindow.onSearchBarItemClickListener;
import com.eeda123.widgets.jazzviewpager.OutlineContainer;
import com.eeda123.zxing.CaptureActivity;
...
public class IndexActivity extends BaseActivity implements OnClickListener,
	...
	private ImageButton serialNoBtn;
	...
	private ImageButton mSearchTransferButton = null;
	private ImageButton mGateoutButton = null;
	...
	protected void findViewById() {
		...
		// mIndexRawPrice = (TextView)
		// findViewById(R.id.index_miaosha_raw_price);
		//
		// mMiaoShaImage = (ImageView) findViewById(R.id.index_miaosha_image);
		// mViewPager = (JazzyViewPager)
		// findViewById(R.id.index_product_images_container);
		// mIndicator = (LinearLayout)
		...
		mSearchTransferButton = (ImageButton) findViewById(R.id.index_search_transfer_order_btn);
		mSearchTransferButton.setOnClickListener(indexClickListener);
		
		mGateoutButton = (ImageButton) findViewById(R.id.index_recharge_btn);
		mGateoutButton.setOnClickListener(indexClickListener);
		...
		serialNoBtn = (ImageButton) findViewById(R.id.index_serial_no_btn);
		serialNoBtn.setOnClickListener(indexClickListener);
	}
	...
	private OnClickListener indexClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.index_search_transfer_order_btn:
				mIntent = new Intent(IndexActivity.this,
						SearchTransferOrderActivity.class);
			...
			case R.id.index_recharge_btn:
				...
				startActivity(mIntent);
				break;
			case R.id.index_serial_no_btn:
				// mIntent=new Intent(IndexActivity.this, CartActivity.class);
				// startActivity(mIntent);
