...
public class SearchResultActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_transfer_order_result);

        initSearchResult(); // 初始化查询结果
        findViewById();
        
        listAdapter = new SearchResultAdapter(
                SearchResultActivity.this, R.layout.search_result_item,
                searchResultList);
    ...
    private void initSearchResult() {
        ...
        Map<String, ?> dto  = (HashMap) intent
                .getSerializableExtra("result_dto");
        totalAmount = ((Double)dto.get("iTotalRecords")).intValue();
        ...
        for (Object obj : (List)dto.get("orderList")) {
            ...
            SearchResultItem item = new SearchResultItem(
                    ...
                    new Date(),
                    R.drawable.android_personel_all_order);
