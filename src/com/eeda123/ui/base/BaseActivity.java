...
import com.eeda123.AppManager;
import com.eeda123.config.Constants;
import com.eeda123.image.ImageLoaderConfig;
import com.eeda123.task.AsyncCallable;
import com.eeda123.task.Callback;
import com.eeda123.task.EMobileTask;
import com.eeda123.task.ProgressCallable;
...
//獲得設備信息
 ...
 protected String getCountry() {
	...
	protected <T> void doAsync(final int pTitleResID, final int pMessageResID, final Callable<T> pCallable, final Callback<T> pCallback, final Callback<Exception> pExceptionCallback) {
		com.eeda123.task.EMobileTask.doAsync(this, pTitleResID, pMessageResID, pCallable, pCallback, pExceptionCallback);
	}
