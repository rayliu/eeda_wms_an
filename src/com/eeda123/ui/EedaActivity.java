...
public class EedaActivity extends BaseActivity {

	public static final String TAG = EedaActivity.class.getSimpleName();
	...
	protected void initView() {
		...
		translate.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
			    ...
			    String sessionId = pref.getString("JSEESIONID", "");
			    EedaHttpClient.setSessionId(sessionId);
